...
{
    /// <summary>
    /// BaseDataAccess类提供对OleDb数据库公共数据访问的抽象基类。
    /// </summary>
    ...
    public abstract class BaseDataAccess<T> : BaseSelect<T>, IBaseDataAccess<T>
    {
        ...
        protected virtual string GenerateUpdateSql(string condition, DataFieldMapTable mapTable, string targetTable, params object[] parameterValues)
        {
            ...
            StringBuilder setValues = new StringBuilder();
            List<OleDbParameter> sqlParameters = null;
            ...
            if (parameterValues != null &&
                parameterValues.Length > 0)
            {
                sqlParameters = new List<OleDbParameter>(parameterValues.Length);
                foreach (OleDbParameter parameter in this.FillParameters(parameterValues))
                {
                    sqlParameters.Add(parameter);
                }
        ...
        public virtual int InsertWithId(T entity, params string[] columnNames)
        {
            ...
            using (OleDbConnection oleDbConnection = new OleDbConnection(this._connectionString))
            {
                ...
                oleDbCmd.CommandText = sqlExpr.CommandText;
                oleDbCmd.Parameters.AddRange(sqlExpr.Parameters);
        ...
        public virtual int DeleteWithCondition(string condition, params object[] parameterValues)
        {
            ...
            return OleDbHelper.ExecuteNonQuery(this._connectionString, CommandType.Text, sqlCmd, parameters);
        }
        ...
        public virtual int DeleteAll()
        {
            ...
            return OleDbHelper.ExecuteNonQuery(this._connectionString, CommandType.Text, sqlCmd);
        }
        ...
        public virtual void Truncate()
        {
            ...
            OleDbHelper.ExecuteNonQuery(this._connectionString, CommandType.Text, sqlCmd);
        }
        ...
        public virtual int Insert(List<BatchEntity<T>> batchEntities)
        {
            ...
            return OleDbHelper.ExecuteNonQuery(this._connectionString, CommandType.Text, batchSqlText.ToString());
        }
