...
namespace Enyim.Caching.Configuration
{
	...
	public class MemcachedClientConfiguration : IMemcachedClientConfiguration
	{
		...
		/// <summary>
		/// Gets or sets the <see cref="T:Enyim.Caching.Memcached.IPerformanceMonitor"/> instance which will be used monitor the performance of the memcachedClient.
		/// </summary>
		public IPerformanceMonitor PerformanceMonitor { get; set; }

		/// <summary>
		/// Gets or sets the type of the communication between memcachedClient and server.
		/// </summary>
