...
using Enyim.Membase.Configuration;

namespace Enyim.Membase
{
	/// <summary>
	...
	public class MembaseClient : MemcachedClient
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Enyim.Membase.MembaseClient" /> class using the default configuration and bucket.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Enyim.Membase.MembaseClient" /> class using the default configuration and the specified bucket.
		/// </summary>
		/// <remarks>The configuration is taken from the /configuration/membase section.</remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Enyim.Membase.MembaseClient" /> class using the specified configuration 
