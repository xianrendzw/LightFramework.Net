...
{
    /// <summary>
    /// Memcached C# memcachedClient, utility class for Socket IO.
    /// 
    ...
    public class SockIO
    {
        ...
        /// </summary>
        /// <param name="sockIOPool">Pool this object is tied to</param>
        ...
        /// connection.
        /// 
        /// This should be backed by a thread sockIOPool.  Any volunteers?
        /// </summary>
        ...
        /// <summary>
        /// sets closed flag and checks in to connection sockIOPool
        ...
        private static ResourceManager _resourceManager = new ResourceManager("LightFramework.Caching.Memcached.Whalin.Caching.Memcached.StringMessages", typeof(SockIO).Assembly);
